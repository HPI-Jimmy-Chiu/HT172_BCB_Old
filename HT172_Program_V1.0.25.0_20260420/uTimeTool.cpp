...
//---------------------------------------------------------------------------
void uTimeTool::GetNowDateTime(Word& SystemYear,Word& SystemMonth,Word& SystemDate,Word& SystemHour,Word& SystemMin,Word& SystemSec,Word& SystemMSec)
{
    GetDetailDateTime(Now(),SystemYear, SystemMonth, SystemDate, SystemHour, SystemMin, SystemSec, SystemMSec);
}
//---------------------------------------------------------------------------
void uTimeTool::GetDetailDateTime(TDateTime dt,Word& SystemYear,Word& SystemMonth,Word& SystemDate,Word& SystemHour,Word& SystemMin,Word& SystemSec,Word& SystemMSec)
{
    DecodeDate(dt, SystemYear, SystemMonth, SystemDate);
    DecodeTime(dt, SystemHour, SystemMin, SystemSec, SystemMSec);
}
//---------------------------------------------------------------------------
