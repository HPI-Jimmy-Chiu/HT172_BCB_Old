...
//    void __fastcall NMFTP2ListItem(AnsiString Listing);
    void __fastcall NMFTP2Success(TCmdType Trans_Type);
...
//    int __fastcall DoDLRequest(); //Richard 2011/10/5 for KYEC Automation   //20140103 wei
    ...
    AnsiString __fastcall Download_2DSortingList(AnsiString sLotID);      //Frank 20221122 : 2DID sorting for ATK
    void Upload_JHT_log_FTP(AnsiString asSchedule);
};
//---------------------------------------------------------------------------
