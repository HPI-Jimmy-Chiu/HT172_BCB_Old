...
#define CSMC_STOP_EVENT		CSMC_MESSAGE+0
#define CSMC_OUT_PLUSE		CSMC_MESSAGE+1
#define CSMC_COUNT_PLUSE	CSMC_MESSAGE+2
#define CSMC_BANK		    CSMC_MESSAGE+3
#define CSMC_LTC_EVENT		CSMC_MESSAGE+4
