...
{
//    return pClinetSocket->Socket->Connected;
    return bConnected;
}
bool ModbusTCPClient::SendData(int iID,int iSlave,int iFunctionCode,int iAddr,VTBYTEDATA data)
{
    ...
    else
    {
        ...
        ByteData[6]=iSlave;
        //Function Code
        ByteData[7]=iFunctionCode;
        //Start register addr
        ByteData[8]=HIBYTE(iAddr);
...
bool ModbusTCPClient::GetRecevie(int iID,VTBYTEDATA &data,bool bRemove/*=true*/)
{
...
void __fastcall ModbusTCPClient::SocketRead(TObject *Sender, TCustomWinSocket *Socket)
{
    ...
    //檢查資料長度
    iDataSize=ByteData[4]*256+ByteData[5];
